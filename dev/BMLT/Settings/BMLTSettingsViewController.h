...
@property (weak, nonatomic) IBOutlet    UIButton            *forgetEmailButton;
@property (strong, atomic)              UIViewController    *myAboutViewController;
- (IBAction)updateUserLocationNow:(id)inSender;
- (IBAction)lookupLocationChanged:(id)inSender;
- (IBAction)keepUpdatingChanged:(id)inSender;
- (IBAction)retainStateChanged:(id)inSender;
- (IBAction)mapResultsChanged:(id)inSender;
- (IBAction)distanceSortChanged:(id)inSender;
- (IBAction)preferredSearchChanged:(id)inSender;
- (IBAction)numMeetingsChanged:(id)inSender;
