...
- (void)lookupMyLocationWithAccuracy:(CLLocationAccuracy)accuracy;     ///< Tells the app to do a CL lookup. The map (if there is one) will be updated when the location is updated.
